...
try:
    ...
    challengerSummoners = f'{url}league/v4/masterleagues/by-queue/RANKED_SOLO_5x5?{api_key}'
        ...
        try:
            ...
            while beginIndex < 100:
                ...
                try:
                    ...
                    df.to_csv('masterParticipants.csv', index = False, header=True)
        except Exception:
            print("Reconectando")
            time.sleep(30)
            df = pd.DataFrame(matchesInfo)
